...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-background md:peer-data-[variant=inset]:border-border/70 relative flex w-full flex-1 flex-col md:peer-data-[variant=inset]:m-3 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-[2rem] md:peer-data-[variant=inset]:border md:peer-data-[variant=inset]:shadow-[0_24px_60px_rgba(15,23,42,0.08),0_6px_18px_rgba(15,23,42,0.05)] md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-3 md:peer-data-[variant=inset]:before:pointer-events-none md:peer-data-[variant=inset]:before:absolute md:peer-data-[variant=inset]:before:inset-0 md:peer-data-[variant=inset]:before:rounded-[inherit] md:peer-data-[variant=inset]:before:shadow-[inset_0_1px_0_rgba(255,255,255,0.95),inset_0_0_0_1px_rgba(255,255,255,0.55),inset_0_18px_36px_rgba(15,23,42,0.035),inset_0_-10px_24px_rgba(255,255,255,0.65)] md:peer-data-[variant=inset]:after:pointer-events-none md:peer-data-[variant=inset]:after:absolute md:peer-data-[variant=inset]:after:inset-[1px] md:peer-data-[variant=inset]:after:rounded-[calc(2rem-1px)] md:peer-data-[variant=inset]:after:bg-[linear-gradient(180deg,rgba(255,255,255,0.72),rgba(255,255,255,0.18)_22%,transparent_45%)] md:peer-data-[variant=inset]:after:opacity-70 dark:md:peer-data-[variant=inset]:shadow-[0_24px_60px_rgba(0,0,0,0.35),0_6px_18px_rgba(0,0,0,0.2)] dark:md:peer-data-[variant=inset]:before:shadow-[inset_0_1px_0_rgba(255,255,255,0.06),inset_0_0_0_1px_rgba(255,255,255,0.03),inset_0_18px_36px_rgba(0,0,0,0.35),inset_0_-10px_24px_rgba(255,255,255,0.02)] dark:md:peer-data-[variant=inset]:after:bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.015)_24%,transparent_48%)] md:peer-data-[variant=inset]:[&>*]:relative md:peer-data-[variant=inset]:[&>*]:z-10",
        className,
      )}
      {...props}
    />
